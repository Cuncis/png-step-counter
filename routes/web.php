...
use App\Http\Middleware\RedirectAdminsFromApp;
use Illuminate\Support\Facades\Route;
use Inertia\Inertia;

Route::get('/', [HomeController::class, 'index'])->middleware(RedirectAdminsFromApp::class)->name('home');

Route::get('v2', fn () => Inertia::render('welcome'))->name('v2');

Route::middleware(['auth', RedirectAdminsFromApp::class])->group(function () {
